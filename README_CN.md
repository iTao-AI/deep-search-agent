...
本仓库发布 backend、API、CLI、测试、文档、运维脚本和 React 静态 demo console。demo console 是面向 operator 的展示壳，用于说明现有 API、EvidenceLedger、review、verification 和 canonical result 边界；它不新增后端状态，也不成为业务事实源。
...
- React demo console 在 PR1 仅使用静态数据，不调用 backend。
